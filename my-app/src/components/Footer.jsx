      ...
      <div className="container">
        ...
        <div className="footer-top-row">
          <div className="footer-social-links">
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="footer-social-btn instagram" aria-label="Instagram">
              <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="footer-social-btn facebook" aria-label="Facebook">
              <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-bottom-grid">
          <div className="footer-contact">
            ...
            <p className="contact-details">
              <a href="tel:+917208154498">+91 7208154498</a> | <a href="mailto:[dhrumintechnotech@gmail.com]">[dhrumintechnotech@gmail.com]</a>
            </p>
          </div>
        </div>
