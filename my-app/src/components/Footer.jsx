      ...
      <div className="container">
        ...
        <div className="footer-top-row">
          <div className="footer-social-links">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="footer-social-btn github" aria-label="GitHub">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="footer-social-btn linkedin" aria-label="LinkedIn">
              <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-cols">
          ...
          <div className="footer-col">
            <h4>Solutions</h4>
            <ul>
              <li><Link to="/#contact">Enterprise</Link></li>
              <li><Link to="/#contact">Startups</Link></li>
              <li><Link to="/#services">Web Platforms</Link></li>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><Link to="/#why-us">Blog</Link></li>
              <li><Link to="/#why-us">Press Kit</Link></li>
            </ul>
          </div>
          <div className="footer-col">
            <h4>Resources</h4>
            <ul>
              <li><Link to="/#process">Documentation</Link></li>
              <li><Link to="/#process">Whitepapers</Link></li>
              <li><Link to="/#work">Case Studies</Link></li>
              <li><Link to="/#process">API Docs</Link></li>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><Link to="/#contact">Licensing</Link></li>
              <li><Link to="/#contact">Compliance</Link></li>
            </ul>
          </div>
        </div>

        {/* Bottom Form + Contact Grid */}
        <div className="footer-bottom-grid">
          <div className="newsletter-box">
            <span className="kicker">Stay Updated:</span>
            <h3>Subscribe to our Innovators Newsletter</h3>
          ...
          <div className="footer-contact">
            <h4>Contact Us:</h4>
            <p className="contact-address">123 Tech Ave, Neo-City, CA |</p>
            <p className="contact-details">
              <a href="tel:+15551234567">+1 (555) 123-4567</a> | <a href="mailto:contact@novasoft.io">contact@novasoft.io</a>
            </p>
          </div>
        </div>
        ...
        <div className="footer-copyright-bar">
          <div className="footer-copyright-content">
            ...
            <span className="footer-copyright-text">
              © 2024 NOVA SOFTWARE INC. ALL RIGHTS RESERVED.
            </span>
            <div className="diagonal-lines">
              <span className="diagonal-line purple"></span>
              <span className="diagonal-line"></span>
